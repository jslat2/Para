...
public class MainActivity extends AppCompatActivity {
    ...
    public static int currentToDoPosition = -1;
    ...
    public void saveToDo(View v){
        boolean completed = ((CheckBox)findViewById(R.id.completed)).isChecked();
        String complete;
        if(completed){
            complete = "Complete";
        } else{
        ...
        int year = ((DatePicker)findViewById(R.id.dueDate)).getYear();
        int month = ((DatePicker)findViewById(R.id.dueDate)).getMonth();
        int day = ((DatePicker)findViewById(R.id.dueDate)).getDayOfMonth();
        String task  = ((EditText)findViewById(R.id.task)).getText().toString();

        db.saveToDo(db, currentUser, currentClientPosition, complete, year, month, day, task);
    }
    ...
    public void editToDo(View v){
        ...
        db.editToDo(db, currentUser, currentClientPosition, currentToDoPosition, complete, year, month, day, task);
    }
